  ...
  return (
    <StyledSection id="informations">
      ...
      <TwoColumns>
        ...
        <Paragraph>
          <Accordion
            question="Quand peut-on indexer mon loyer ?"
            answer="L'indexation du loyer peut se faire chaque année au plus tôt à la date anniversaire de l'entrée en vigueur du bail."
          />
        </Paragraph>
        <Paragraph>
          <Accordion
            question="Limitation de l'indexation pour les logements passoires (PEB D, E, F et G)"
